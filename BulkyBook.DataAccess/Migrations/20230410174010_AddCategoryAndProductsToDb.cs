    ...
    public partial class AddCategoryAndProductsToDb : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2023, 4, 10, 19, 40, 10, 740, DateTimeKind.Local).AddTicks(978), 1, "Action" },
                    { 2, new DateTime(2023, 4, 10, 19, 40, 10, 740, DateTimeKind.Local).AddTicks(1023), 2, "SciFi" },
                    { 3, new DateTime(2023, 4, 10, 19, 40, 10, 740, DateTimeKind.Local).AddTicks(1025), 3, "History" }
                });
